...
client_id = "b1d5c1ab-0301-4ed0-bf88-15c68a0351b8"
client_secret = "pat1_11e90621371a41c582be84ccd727560434d17559981048bc9fea6540a3aa8b17"

#send_results('path_to_your_report_file.ext', 'YourScanType', 'YourAssessmentName', 'new', client_id, client_secret, scan_target)
#send_results('aqua_example2.json', 'Aqua Scan', 'Sysdig_pipeline_assesm6', 'new', client_id, client_secret, "CD.wpay.com/POC1_CD_wpay_app_backend:latest")
#send_results('aqua_example2.json', 'Aqua Scan', 'Sysdig_pipeline_assesm7', 'new', client_id, client_secret, "CD.wpay.com/POC1_CD_wpay_app_backend:3_2")
#send_results('aqua_example2.json', 'Aqua Scan', 'Sysdig_pipeline_assesm8', 'new', client_id, client_secret, "CD.wpay.com/POC1_CD_wpay_app_backend:3_1")
#send_results('aqua_example2.json', 'Aqua Scan', 'Sysdig_pipeline_assesm9', 'new', client_id, client_secret, "CD.wpay.com/POC1_CD_wpay_app_backend:3_3")
#send_results('aqua_example2.json', 'Aqua Scan', 'Sysdig_pipeline_assesm10', 'new', client_id, client_secret, "CD.wpay.com/POC1_CD_wpay_app_backend:3_0")

send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm7', 'new', client_id, client_secret, "JPMCTEST.wpay.com/POC1_CD_wpay_app_backend:latest")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm8', 'new', client_id, client_secret, "JPMCTEST.wpay.com/POC1_CD_wpay_app_backend:3_2")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm9', 'new', client_id, client_secret, "JPMCTEST.wpay.com/POC1_CD_wpay_app_backend:3_1")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm10', 'new', client_id, client_secret, "JPMCTEST.wpay.com/POC1_CD_wpay_app_backend:3_3")
send_results('aqua_example2.json', 'Aqua Scan', 'Container_pipeline_assesm11', 'new', client_id, client_secret, "JPMCTEST.wpay.com/POC1_CD_wpay_app_backend:3_0")
